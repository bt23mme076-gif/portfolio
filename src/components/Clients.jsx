...
export default function Clients() {
  ...
  return (
    <section id="clients" style={{ padding: '5rem 2.5rem', background: 'var(--bg2)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }}>
      <div ref={ref} style={{ opacity: visible ? 1 : 0, transform: visible ? 'translateY(0)' : 'translateY(20px)', transition: 'opacity .6s, transform .6s' }}>
